...
Regular paragraph text with **bold**, _italic_, **_bold italic_**, and ~~strikethrough~~ formatting. You can also use `inline code` within text.
...
![Streamdown logo](https://img0.baidu.com/it/u=2551318668,885273202&fm=253&app=138&f=JPEG?w=800&h=1428)
![Streamdown logo](https://img0.baidu.com/it/u=4000094149,3812330633&fm=253&fmt=auto&app=138&f=JPEG?w=889&h=500)

---

## Blockquotes

> This is a blockquote. It supports **formatting** and _emphasis_ inside.
>
...
**Japanese:** _こんにちは。_ Streamdown は日本語をサポートしています。
